    ...
    <div class="container" id="maincontainer-index">
        <?php if($hata!='') {echo '<div class="warning-input"><i class="fa-solid fa-circle-info"></i>'.$hata.'</div>';} ?>
            ...
            <div class="row" id ="row-about">
                ...
                <p>CampusCollab is a platform where students can set certain characterisctics for a studying or for any activity such as location, time, number of expected participants and share their activities in a way that other people can see. </p> 
